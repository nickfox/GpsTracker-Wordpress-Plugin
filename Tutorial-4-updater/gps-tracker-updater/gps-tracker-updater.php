...
class Gps_Tracker_Updater {
    ...
    function gpstracker_shortcode($atts) {
        ...
        return sprintf('<a href="%s">Gps Tracker Updater</a>',$this->gpstracker_url($latitude, $longitude, $phonenumber, $sessionid, 
        ...
        if (
            ...
            $wpdb->insert( 
            	...
            	array( 
                    ...
                    'gps_time' => $wp_query->query_vars['gpstime'],
                    ...
                    'event_type' => $wp_query->query_vars['eventtype']
            	), 
            	array( 
